		...
		<div class="col-lg-16">
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group">
                            <label class="control-label">Course Offered</label>
                            <select class="form-control" name="course_id">
                                <?php
                                $course = $conn->query("SELECT id, course_name FROM courses");
					...
					<div class="form-group">
						...
						<select name="schedule_type" id="" class="form-control">
							<option value="1" <?php echo isset($schedule_type) && $schedule_type == 1 ? 'selected' : ''  ?>>Lecture Schedule</option>
							<option value="2" <?php echo isset($schedule_type) && $schedule_type == 2 ? 'selected' : ''  ?>>Lab Schedule</option>
					...
					<div class="form-group">
                            ...
                            <select class="form-control" name="room_id">
                                <?php
                                $room = $conn->query("SELECT id, room FROM rooms");
