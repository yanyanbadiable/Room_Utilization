...
document.addEventListener('DOMContentLoaded', function() {
    calendar = new FullCalendar.Calendar(calendarEl, {
    	...
    	hiddenDays: [0],
        slotMinTime: '07:00:00', // 7:00 am
        slotMaxTime: '22:00:00', // 10:00 pm
        allDaySlot: false, // hide the all-day slot
        events: <?php echo json_encode($get_schedule); ?>,
        eventClick: function(info) {
            var confirmStatusChange = confirm('Clicking OK will change the status of the schedule. Do you wish to continue?');
