                    ...
                    <tbody>
                        <?php foreach ($courses as $course) { ?>
                            <tr>
                                ...
                                <td class="text-center"><button onclick="addOffer('<?php echo $course['id']; ?>')" class="btn btn-success btn-flat"><i class="fa fa-plus-circle"></i></button></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
...
<script>
    function addOffer(courseId) {
        var array = {};
        if ('<?php echo $section_name; ?>' != "") {
            array['course_id'] = courseId;
            array['section_name'] = '<?php echo $section_name; ?>';
